...
| --- | --- | --- | --- |
| `src/game/render/ChameleonRig.ts` | Mario-C | V07-M3C | M3I-requested structural silhouette/reference rework. |
| `src/game/render/SupernarizRig.ts` | Mario-C | V07-M3C | M3I-requested structural silhouette/reference rework. |
