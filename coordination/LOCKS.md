...
| --- | --- | --- | --- |
| `src/game/render/LocomotionPose.ts` | Mario | V07-M2 | El Toro heavy locomotion style |
| `src/game/render/ElToroRig.ts` | Mario | V07-M2 | new procedural articulated El Toro rig |
