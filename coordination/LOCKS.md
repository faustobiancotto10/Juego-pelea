...
| src/game/render/ | Mario | V06-M2 | Cancha 56 + projectile/Clash/Ultimate presentation |
| tests/render-v06.test.mjs | Mario | V06-M2 | M1 + stage/projectile/Clash presentation regressions |
