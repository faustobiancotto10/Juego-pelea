...
| tests/combat-v03.test.mjs | Ricardo | R-101 | targeted V0.3 gameplay regression coverage |
| tests/g401-adversarial-v03.test.mjs | Germinator | G-401 | adversarial/balance harness isolated from Ricardo V0.3 regression file |
| src/game/input/ | Brancaforte | B-301 | V0.3 action chord/context routing and touch/keyboard input |
| src/game/ui/ | Brancaforte | B-301 | HUD, controls/help and transient SUPER UX |
