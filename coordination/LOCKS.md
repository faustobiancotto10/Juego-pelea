...
| src/game/data/projectiles.ts | Ricardo | V05-R2 | projectile definitions |
| src/game/data/ultimates.ts | Ricardo | V05-R2 | Ultimate definitions |
| src/game/types.ts | Ricardo | V05-R2 | registry-validated fighter/content contract |
| src/game/simulation/moves.ts | Ricardo | V05-R2 | move metadata/data access migration |
| src/game/simulation/CombatSimulation.ts | Ricardo | V05-R2 | injected registry and data-driven dispatch |
