...
| ↳ Mario-B | El Toro sprite package | V07-SPR-MB | BLOCKED_EXTERNAL_INPUTS | Right package GREEN at `a5dfaa6...` / run `35674533122`: deterministic body+FX atlases, 26-key runtime fragment, 844x390 preview and memory/hash receipt. Wait on authored LEFT set, verified anchors and Ricardo crouch/block timeline amendment. |
