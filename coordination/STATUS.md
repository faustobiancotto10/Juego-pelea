...
| Brancaforte | UI / Input / UX Engineer | R003-V05-COMBAT-LOOP | V05-B1,B2 | CHECKING_IN | user activation required | Stage 4 B2 authorized for check-in after G1 approval |
