...
| --- | --- | --- | --- | --- | --- | --- |
| Neureon | Lead / Coordinator | R001-V03-COMBAT-EXPANSION | N-001 | WORKING | final integration/release pending | Germinator final QA PASS; advancing to Gonza release stage |
...
| Gonza | Integration / Release | R001-V03-COMBAT-EXPANSION | Z-501 | WAITING_FOR_TEAM | Neureon must transition global lifecycle from ACTIVE to RELEASE before merge/publication | candidate 0a613a527366a0e8c95e3febf9ca190f4321ed9b; CI #175 green; desktop/mobile-landscape smoke green; play.html V0.3 synchronized |
