...
| Mario | Character / Rendering Engineer | V06-M1→M2 | READY | G1 green; start V06-M1 immediately on accepted product d815694a. |
| Brancaforte | UI / Input / UX Engineer | V06-B1 | READY | G1 green; start V06-B1 immediately on accepted product d815694a. |
