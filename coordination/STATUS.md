...
| Gonza | Integration / Release | R001-V03-COMBAT-EXPANSION | Z-501 | READY | user activation needed | Germinator PASS FOR INTEGRATION; integrate accepted SHAs, run full integrated verification and release smoke |
