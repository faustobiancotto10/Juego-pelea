...
| Germinator | Auditor / QA | R003-V05-COMBAT-LOOP | V05-G1,G2 | CHECKING_IN | user activation required for corrected AC06 predicate | prior BLOCK predicate invalidated by pre-impact evidence; rerun full G1 required |
