...
| --- | --- | --- | --- | --- | --- | --- |
| Neureon | Lead / Coordinator | R003-V05-COMBAT-LOOP | V05-N1 | READY | waiting G1 verdict | Stage 3 QA running |
...
| Germinator | Auditor / QA | R003-V05-COMBAT-LOOP | V05-G1,G2 | WORKING | none | START_ROUND Stage 3; audit frozen core 8e74d1e7 |
