...
| ↳ Mario-B | Temporary lane — El Toro + Juanchi | V07-M3B | READY | Reopened by M3I visual review for stronger El Toro/Juanchi structural/reference pass; prior green SHA remains historical input only. |
| ↳ Mario-C | Temporary lane — Camaleoni + Supernariz | V07-M3C | READY | Reopened by M3I visual review for stronger silhouette/reference pass; prior green SHA remains historical input only. |
