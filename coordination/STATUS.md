...
| --- | --- | --- | --- | --- | --- | --- |
| Neureon | Lead / Coordinator | R002-V04-COMBAT-FEEL-MOBILE | N-002 | WORKING | waiting for Germinator PRESENT | Stage 3 validation opened |
...
| Germinator | Auditor / QA | R002-V04-COMBAT-FEEL-MOBILE | G-402 | WORKING | none | PRESENT posted; composing exact frozen Stage 3 candidate and adversarial QA |
