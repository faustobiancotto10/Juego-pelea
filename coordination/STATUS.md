...
| Mario | Character / Rendering Engineer | V07-M1→M2 | READY | Start V07-M1 immediately from accepted gameplay/core dependency. |
| Brancaforte | UI / Input / UX Engineer | V07-B1 | READY | Start V07-B1 immediately from accepted gameplay/core dependency. |
