...
| Mario | Character / Rendering Engineer | V07-M1→M2→M3 | WORKING | V07-M3 active on `repair/v07-character-pipeline-v2`: structural profiles + four-rig differentiation + shared portraits. |
