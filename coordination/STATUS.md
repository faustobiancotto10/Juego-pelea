...
| ↳ Mario-B | El Toro sprite package | V07-SPR-MB | BLOCKED_EXTERNAL_INPUTS | Final RIGHT package + anchor-review candidate GREEN at `e6f1602...` / run `35674856169`: deterministic 84-body + 22-FX atlases, 26-key fragment, 844x390 atlas-only preview, metrics/hash receipt and 84-frame verified-anchor gate. Wait on authored LEFT set, visual anchor coordinates and Ricardo crouch/block/block-crouch timeline amendment. |
