...
| ↳ Mario-B | El Toro sprite package | V07-SPR-MB | HANDOFF_READY_RIGHT_ONLY | Final exact RIGHT candidate `e6f1602...` GREEN on run `35674856169`; atlas/FX/26-key manifest/preview/metrics/CLI + 84-frame anchor-review workflow complete. Production remains blocked on authored LEFT, verified anchors, and Ricardo crouch/block/block-crouch timeline amendment. |
