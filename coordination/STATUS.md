...
| Ricardo | Gameplay Engineer | R003-V05-COMBAT-LOOP | V05-R1..R5 | BLOCKED | AC06 G1 predicate checks post-hit moveId after interruption clears it; waiting Neureon/Germinator contract decision | RED reproduced; pre-impact proof shows Coletazo frame26 same-side clean punish |
