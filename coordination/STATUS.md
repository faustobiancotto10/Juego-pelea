...
| ↳ Mario-B | El Toro sprite package | V07-SPR-MB | BLOCKED_EXTERNAL_INPUTS | Right package + anchor-review workflow GREEN at `63ed61f...` / run `35674688193`: deterministic body+FX atlases, 26-key fragment, 844x390 preview, memory/hash receipt, 84 packed pivots and verified-anchor gate. Wait on authored LEFT set, visual anchor coordinates and Ricardo crouch/block timeline amendment. |
