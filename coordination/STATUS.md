...
| Germinator | Auditor / QA | V07-G1→G2 | READY | V07-G2 is unblocked by Mario M3 green candidate e053e0b1; independently audit roster differentiation/runtime boundaries. |
| Mario | Character / Rendering Engineer | V07-M1→M2→M3 | VERIFIED | V07-M3 green at `e053e0b187acff3b4555ce8d537e9fd9ca616303`; handoff published to Germinator G2; available for targeted repair only. |
