...
| ↳ Mario-B | El Toro sprite package | V07-SPR-MB | BLOCKED_EXTERNAL_INPUTS | RIGHT package + gated anchor-review workflow GREEN at `51e0e892...` / run `35675088000`. Deterministic body+FX atlases, 26-key runtime fragment, gameplay preview, metrics/fingerprints, 84-frame anchor JSON+SVG review are ready. Wait on authored LEFT, verified anatomical anchor coordinates and Ricardo crouch/block timeline amendment. |
