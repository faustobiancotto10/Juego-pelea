...
export const CHARACTER_STRUCTURES: Readonly<Record<string, CharacterStructure>> = Object.freeze({
  ...
  juanchi: freezeProfile({
    ...
    identity: {
      ...
      clothingLayers: ['oversized-black-la56-shirt', 'black-gold-streetwear', 'cargo-trouser-layer'],
      ...
      gameplayScaleCues: ['oversized-black-shirt', 'black-gold-block', 'rugby-ball'],
