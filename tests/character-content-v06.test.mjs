...
test('released Character Packages preserve legacy order and append V0.7 fighter four', () => {
  assert.deepEqual([...DEFAULT_CHARACTER_COMPOSITION.packageIds], ['chameleon', 'supernariz', 'juanchi', 'el-toro']);
  assert.deepEqual([...FIGHTER_IDS], ['chameleon', 'supernariz', 'juanchi', 'el-toro']);
...
test('R0 fourth synthetic Character Package registers structurally without entering released playable roster', () => {
  ...
  assert.deepEqual([...composition.packageIds], ['chameleon', 'supernariz', 'juanchi', 'el-toro', fourthPackageId]);
